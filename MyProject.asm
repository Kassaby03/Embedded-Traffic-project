...
;MyProject.c,41 :: 		void autoTraffic()
;MyProject.c,43 :: 		int i=0;
	...
	MOVWF      R0+0
	CALL       ___CC2DW+0
;MyProject.c,45 :: 		power=1;
	BSF        PORTB+0, 2
;MyProject.c,46 :: 		power1=1;
	BSF        PORTB+0, 3
;MyProject.c,47 :: 		while(1)
L_autoTraffic6:
;MyProject.c,50 :: 		for(i=14;i>=0;i--)
	MOVLW      14
...
L__autoTraffic44:
	BTFSS      STATUS+0, 0
	GOTO       L_autoTraffic9
;MyProject.c,51 :: 		{    if(flag%2==0) return;
	MOVLW      1
	ANDWF      _flag+0, 0
	MOVWF      R1+0
	MOVF       R1+0, 0
...
;MyProject.c,54 :: 		traffic=0b010001;
	MOVLW      17
	MOVWF      PORTC+0
	GOTO       L_autoTraffic13
L_autoTraffic12:
;MyProject.c,56 :: 		traffic=0b100001;
	MOVLW      33
	MOVWF      PORTC+0
L_autoTraffic13:
...
;MyProject.c,60 :: 		{     if(flag%2==0) return;
	MOVLW      1
	ANDWF      _flag+0, 0
	MOVWF      R1+0
	MOVF       R1+0, 0
...
;MyProject.c,63 :: 		traffic=0b001010;
	MOVLW      10
	MOVWF      PORTC+0
	GOTO       L_autoTraffic20
L_autoTraffic19:
;MyProject.c,65 :: 		traffic=0b001100;
	MOVLW      12
	MOVWF      PORTC+0
L_autoTraffic20:
...
;MyProject.c,70 :: 		void manualTraffic()
;MyProject.c,72 :: 		int i=0;
	...
	MOVWF      R0+0
	CALL       ___CC2DW+0
;MyProject.c,74 :: 		switchManualModeDir=1;
	BSF        TRISB+0, 1
;MyProject.c,75 :: 		power=0;
	BCF        PORTB+0, 2
;MyProject.c,76 :: 		power1=0;
	BCF        PORTB+0, 3
;MyProject.c,77 :: 		while(1)
L_manualTraffic22:
;MyProject.c,78 :: 		{        for(i=2;i>=0;i--)
	MOVLW      2
...
;MyProject.c,79 :: 		{      if(flag%2==1) return;
	MOVLW      1
	ANDWF      _flag+0, 0
	MOVWF      R1+0
	MOVF       R1+0, 0
...
L_manualTraffic27:
;MyProject.c,80 :: 		power1=1;
	BSF        PORTB+0, 3
;MyProject.c,81 :: 		ssd=num[i];
	...
	MOVF       INDF+0, 0
	MOVWF      PORTD+0
;MyProject.c,82 :: 		traffic=0b010001;
	MOVLW      17
	MOVWF      PORTC+0
...
;MyProject.c,84 :: 		}    power1=0;
	GOTO       L_manualTraffic24
L_manualTraffic25:
	BCF        PORTB+0, 3
;MyProject.c,85 :: 		traffic=0b100001;
	MOVLW      33
	MOVWF      PORTC+0
;MyProject.c,86 :: 		while(switchManualMode!=1){if(flag%2==1) return;}
L_manualTraffic29:
	BTFSC      PORTB+0, 1
...
;MyProject.c,88 :: 		{    if(flag%2==1) return;
	MOVLW      1
	ANDWF      _flag+0, 0
	MOVWF      R1+0
	MOVF       R1+0, 0
	...
	GOTO       L_end_manualTraffic
L_manualTraffic35:
;MyProject.c,89 :: 		power=1;
	BSF        PORTB+0, 2
;MyProject.c,90 :: 		ssd=num[i];
	MOVF       manualTraffic_i_L0+0, 0
	MOVWF      R0+0
	MOVF       manualTraffic_i_L0+1, 0
	MOVWF      R0+1
	...
	MOVF       INDF+0, 0
	MOVWF      PORTD+0
;MyProject.c,91 :: 		traffic=0b001010;
	MOVLW      10
	MOVWF      PORTC+0
...
;MyProject.c,87 :: 		for(i=2;i>=0;i--)
	...
	BTFSS      STATUS+0, 0
	DECF       manualTraffic_i_L0+1, 1
;MyProject.c,93 :: 		}    power=0;
	GOTO       L_manualTraffic32
L_manualTraffic33:
	BCF        PORTB+0, 2
;MyProject.c,94 :: 		traffic=0b001100;
	MOVLW      12
	MOVWF      PORTC+0
;MyProject.c,95 :: 		while(switchManualMode!=1){if(flag%2==1) return;};
L_manualTraffic37:
	BTFSC      PORTB+0, 1
